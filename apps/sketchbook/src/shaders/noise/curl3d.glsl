...
vec3 curl(vec3 p) {
  ...
  vec3 p_x0 = snoise_vec3(p - dx);
  vec3 p_x1 = snoise_vec3(p + dx);
  vec3 p_y0 = snoise_vec3(p - dy);
  vec3 p_y1 = snoise_vec3(p + dy);
  vec3 p_z0 = snoise_vec3(p - dz);
  vec3 p_z1 = snoise_vec3(p + dz);
