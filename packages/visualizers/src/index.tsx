export { default as VisualizerOne } from "@/visualizers/1";
export { default as VisualizerTwo } from "@/visualizers/2";
export { default as VisualizerThree } from "@/visualizers/3";
